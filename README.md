...
```ts
const first = {
  stack:     ["Unity / C#", "Next.js", "React", "MangoDB"],
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=cs,python,js,react,nextjs,tailwind,nodejs,postgresql,unity,unreal,git,c,css,html,docker,nextjs&theme=dark&perline=11" />
</div>
